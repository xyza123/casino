...
OUT:= game
SOURCE = Main.cpp GameWindow.cpp global.cpp Texas.cpp poker.cpp player.cpp roulette.cpp
OBJ = Main.o GameWindow.o global.o Texas.o poker.o player.o roulette.o
